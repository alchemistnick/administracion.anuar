...
with tab_reportes:
    ...
    if tipo_reporte == "🏫 Escuelas que NO han pagado":
        ...
        # Cruzamos las asignaciones de las delegaciones con los integrantes o listamos las bancas asignadas con sus delegaciones
        if asignaciones_rep:
        ...
        # Personas en nómina que no cuentan con asignación o cuyo criterio esté pendiente
        if nominas_rep:
            # Filtramos aquellos cuya asignación esté vacía o general
